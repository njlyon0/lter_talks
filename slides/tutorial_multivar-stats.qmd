...
![](images_tutorials/nms_heli-1.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-2a.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-2b.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-3.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-4.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-5.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-6.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-7.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-8.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-9.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-10.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-11.png){.absolute top=150 left=25 .fragment .fade-in}
![](images_tutorials/nms_heli-12.png){.absolute top=150 left=25 .fragment .fade-in}
